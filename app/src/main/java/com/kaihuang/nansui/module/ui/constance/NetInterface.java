package com.kaihuang.nansui.module.ui.constance;
...
public class NetInterface {
    ...
    //    public static String ALL_URL = "http://app.srv.quchangkeji.com:8083/tsAPI";//外网地址
//    public static String ALL_URL = "http://test.app.srv.quchangkeji.com:8083/tsAPI";//内网测试地址
...
//    public static String ALL_URL = "http://app.srv.quchangkeji.com:8083/tsAPI";//外网地址（旧）
    ...
    //	public static String ALL_URL = "http://192.168.3.6:8080/tsAPI";
...
//	public static String ALL_URL = "http://test.app.srv.quchangkeji.com:8083/tsAPI";
    public static String H5_URL = " http://www.quchangkeji.com/kSteward/";//相关协议跳转

    public static String SERVER_URL = ALL_URL + "/";// 测试接口地址（1.0版本）
    public static String SERVER_XIEYI = "https://www.baidu.com/";//注册协议
    public static String SHARE_URL = "http://fir.im/tosingbeta";//分享url
    public static String SHARE_apk = "http://fir.im/tosingbeta";//分享图标 https://dl.quchangkeji.com/app/android.apk
...
//    public final static String FileTarget = MyFileUtil.DIR_IMAGE.toString() + File.separator;// 本地图片保存地址。(二维码)
     ...
     ******/
    //appid 微信分配的公众账号ID
    public static final String APP_ID = "wx11f4ad30030a2ea6";//wx11f4ad30030a2ea6   wx14af47ab474a0991
    //商户号 微信分配的公众账号ID
    public static final String MCH_ID = "1431437602";//1431437602 1415675302
    //  API密钥，在商户平台设置
    public static final String API_KEY = "191da07eb3af1a848548e884faa43eab";//191da07eb3af1a848548e884faa43eab  ganzhoualpha112114115WXZHOUALPHA
