...
import com.kaihuang.nansui.common.utils.LanguageUtil;
...
//        LogUtils.log("params", content);//打开用于查看测试数据
     ...
     */
    private void requestGetBySyn(String actionUrl, String token , Callback callback) {

        OkHttpClient okHttpClient = new OkHttpClient();
        Request request = new Request.Builder()
                .addHeader("token", token)  //请求头中加入参数
                .url(actionUrl) //携带参数
                .build();
